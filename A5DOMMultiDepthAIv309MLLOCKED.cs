...
namespace NinjaTrader.NinjaScript.Indicators
{
    ...
    public static class BurstTypes { public const byte NONE=0; public const byte SAME_EXCH_TS=1; public const byte PRICE_CLUSTER=2; }
        ...
        private void EnsureWriter(DomState d)
        {
            ...
            try { today = sessionIterators[0].GetTradingDay(Core.Globals.Now).ToString("yyyyMMdd", CultureInfo.InvariantCulture); } catch {}
        ...
        {
            var d = dom[idx];
            string today = sessionIterators[idx].GetTradingDay(Core.Globals.Now).ToString("yyyyMMdd", CultureInfo.InvariantCulture);
